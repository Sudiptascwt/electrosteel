...
@Module({
  imports: [TypeOrmModule.forFeature([AboutMain, growing_strength_data, AboutDuctileIron, ManufacturingFacilities, headings, AboutPeopleData, about_technology_innovation, CommonTitle])],
