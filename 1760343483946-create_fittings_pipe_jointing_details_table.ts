...
export class CreateFittingsPipeJointingDetailsTable1760343483946 implements MigrationInterface {
 ...
 public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createForeignKey(
      ...
      new TableForeignKey({
        ...
        referencedTableName: 'ductile_iron_fittings_pipes_jointing',
